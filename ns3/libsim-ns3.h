#ifndef __SIM_NS3_ML_H__
#define __SIM_NS3_ML_H__
...
#if !defined(PART_OF_SIM_NS3) && \
    !defined(STATIC_LINK_SIM_NS3) && \
    !defined(DYNAMIC_LINK_SIM_NS3)
#define DYNAMIC_LINK_SIM_NS3
#endif

#if defined(PART_OF_SIM_NS3)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_SIM_NS3)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_SIM_NS3)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for sim_ns3
#define MLLIB_PRIVATE(x)
...
MLLIB_PUBLIC(void sim_ns3_open(int argc, const char** argv);)
MLLIB_PUBLIC(void sim_ns3_close();)
MLLIB_PRIVATE(void mlton_sqlite3_ufnhook (CPointer x0, Int32 x1, CPointer x2);)
MLLIB_PRIVATE(void mlton_sqlite3_uagstep (CPointer x0, Int32 x1, CPointer x2);)
MLLIB_PRIVATE(void mlton_sqlite3_uagfinal (CPointer x0);)
MLLIB_PRIVATE(Int32 mlton_sqlite3_colhook (CPointer x0, Int32 x1, CPointer x2, Int32 x3, CPointer x4);)
MLLIB_PRIVATE(Int32 mlton_sqlite3_authhook (CPointer x0, Int32 x1, CPointer x2, CPointer x3, CPointer x4, CPointer x5);)
MLLIB_PUBLIC(void bs_event_fire (Int32 x0);)
MLLIB_PUBLIC(void bs_udp_recv_callback (Int32 x0);)
MLLIB_PUBLIC(void bs_log_add_filter (CPointer x0, Int32 x1, Int32 x2);)
MLLIB_PUBLIC(void bs_statistics_log_interval (Int64 x0);)
MLLIB_PUBLIC(Int32 bs_app_start (CPointer x0, Int32 x1, CPointer x2, Int32 x3, CPointer x4, CPointer x5, Int32 x6);)
MLLIB_PUBLIC(Int32 bs_app_stop (Int32 x0);)
